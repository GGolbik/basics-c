...
- [Example 2](example-2/README.md)
  - A simple template to build a C project, run test and get coverage report.
...
Standard `C17` is the informal name for `ISO/IEC 9899:2018` 
